<h1 class="text-primary"><i class="fa fa-user-plus"></i> Add Student <small>Add New Studetn</small> </h1>
...
if ($result) {
  ...
  move_uploaded_file($_FILES['picture']['tmp_name'],'student_img/'.$picture_name);
}else {
  $error = "Wrong";
}
  ...
  <div class="col-sm-6">
    <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <input type="text" name="pcontact" placeholder="01*******" id="pcontact" class="form-control" required="" pattern="01[1|5|6|7|8|9][0-9]{8}" >
      ...
      <div class="form-group">
      <input type="submit" name="add-student" value="Add Studetn"
