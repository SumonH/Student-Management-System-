<h1 class="text-primary"><i class="fa fa-pencil-square-o"></i> Update Student <small>Update Studetn</small> </h1>
  ...
  <div class="col-sm-6">
    <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <input type="text" name="pcontact" placeholder="01*******" id="pcontact" class="form-control" required=""  pattern="01[1|5|6|7|8|9][0-9]{8}" value="<?=$db_row['pcontact']?>" >
      ...
      <div class="form-group">
      <input type="submit" name="update-student" value="update Student"
